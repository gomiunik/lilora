...
class GatewayInfoAdapter extends TypeAdapter<GatewayInfo> {
  @override
  final int typeId = 2;

  @override
  GatewayInfo read(BinaryReader reader) {
    final numOfFields = reader.readByte();
    final fields = <int, dynamic>{
      for (int i = 0; i < numOfFields; i++) reader.readByte(): reader.read(),
    };
    return GatewayInfo(
      gatewayId: fields[0] as String,
      rssi: fields[1] as double,
      snr: fields[2] as double,
  ...
  @override
  void write(BinaryWriter writer, GatewayInfo obj) {
    writer
      ..writeByte(6)
      ..writeByte(0)
      ..write(obj.gatewayId)
...
class RangePointAdapter extends TypeAdapter<RangePoint> {
  ...
  RangePoint read(BinaryReader reader) {
    ...
    return RangePoint(
      ...
      gateways: (fields[18] as List?)?.cast<GatewayInfo>(),
      gatewayCount: fields[19] as int?,
    );
  }
